    ...
    always @(*) begin
        case(cnt_val)
            ...
            4'd6: begin // 700Hz
                ...
                seg_BB = 7'b0111111; // '0'
                seg_CC = 7'b0111111; // '0'
                freq_M = 24'd10946;  // 700 * 15.636531
            end
            ...
            4'd7: begin // 800Hz
                ...
                seg_BB = 7'b0111111; // '0'
                seg_CC = 7'b0111111; // '0'
                freq_M = 24'd12509;  // 800 * 15.636531
            end
            ...
            4'd8: begin // 900Hz
                ...
                seg_BB = 7'b0111111; // '0'
                seg_CC = 7'b0111111; // '0'
                freq_M = 24'd14073;  // 900 * 15.636531
            end
            ...
            4'd9: begin // 990Hz
                ...
                seg_BB = 7'b1101111; // '9'
                seg_CC = 7'b0111111; // '0'
                freq_M = 24'd15480;  // 990 * 15.636531
            end
